...
// ------------------------------------------------------------------
// fast ellipse generator (uses fast_sin_u16, WRITE_BOTH)
//  • rx, ry  : radii in DAC units  (0–2048 typical)
//  • cx, cy  : center position    (0–4095 each)
//  • time_us : total time for one full ellipse
// ------------------------------------------------------------------
